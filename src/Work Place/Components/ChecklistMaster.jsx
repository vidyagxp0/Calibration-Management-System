...
<div className='flex flex-col py-3'>
                <label className='text-[14px] font-medium pb-2'>CheckList Id</label>
                <input className="border border-gray-500 rounded p-2 "/>

            </div>
            <div className='flex flex-col py-3'>
                <label className='text-[14px] font-medium pb-2'>Description</label>
            <input className="border border-gray-500 rounded p-2 "/>
            </div>
            <div className='flex flex-col py-3'>
...
<div className='flex flex-col py-3'>
                <label className='text-[14px] font-medium pb-2'>Applied Pressure:s</label>
                <input className="border border-gray-500 rounded p-2 "/>

            </div>
            <div className='pt-[42px]'><button className='p-2 bg-gray-600 w-full'>Add</button></div>
</div>
